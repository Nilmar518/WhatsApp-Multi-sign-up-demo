...
export default function MappingReviewModal({ staged, onComplete }: Props) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
      ...
      {/* ── Success banner ─────────────────────────────────────────────────── */}
      {allMapped && (
        <div className="mx-6 mt-5 flex items-center gap-3 rounded-xl bg-green-50 border border-green-200 px-4 py-3">
      ...
      {/* ── Bulk error ────────────────────────────────────────────────────── */}
      {bulkError && (
        <div className="mx-6 mt-5 rounded-xl bg-red-50 border border-red-200 px-4 py-3 text-sm text-red-700">
              ...
              {rows.map((row, idx) => {
                ...
                return (
                  <tr key={airbnbId} className={isMapped ? 'opacity-60' : ''}>
                    {/* Index */}
                    <td className="py-4 pr-4 text-gray-300 font-mono text-xs align-top pt-5">
                      {idx + 1}
                    </td>
                    ...
                    <td className="py-4 pr-4 align-top">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className="text-xs text-gray-400 font-mono">{airbnbId}</span>
                        ...
                        <span className="text-gray-200">·</span>
                        <span className="text-xs text-gray-400">{capacity} guests</span>
                      </div>
